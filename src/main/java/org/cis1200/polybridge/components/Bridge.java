...
import org.cis1200.polybridge.truss.Truss;
import org.cis1200.polybridge.truss.Vec2D;
...
public class Bridge {
    ...
    public static final int BRIDGE_LEFT_Y = 500;
    ...
    public boolean solveMemberForces(double loadX, double loadForce) {
        System.out.println("Solving for load at " + loadX);
        Truss t = getTruss();
