...
public class HelpPanel extends JPanel {
    public HelpPanel(MainFrame frame) {
        ...
        instructions.setText("""
                ...
                You are an engineer tasked with designing a new bridge to get from Locust to 1920 Commons.
                Use this tool to design the bridge and get funding from the Penn Board of Trustees!
                
                1. Use the "Joint" tool to place joints. There are 5 pre-built joints along the deck bridge.
                2. Use the "Member" tool to click and drag beams between the joints. Remember to put members along the bridge deck.
                3. If you make a mistake, use the "Select" tool to move joints and members around, or use the "Undo" tool to undo.
